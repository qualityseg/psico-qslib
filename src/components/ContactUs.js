      ...
      <main className="main-content">
        <div className="contact-section">
          ...
          <div className="whatsapp-section fade-in-right">
            <a href="https://api.whatsapp.com/send/?phone=5514996361105&text=&type=phone_number&app_absent=0" target="_blank" rel="noreferrer noopener" className="whatsapp-button">Contate-nos via WhatsApp</a>
          </div>
        </div>
      </main>
